...
<body>
                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($data)) {
                            ...
                            echo "<button style='background-color: green;' type='button' class='btn btn-primary form-btn' data-bs-toggle='modal' data-bs-target='#formmodal' data-patient-id='" . $row['patient_id'] . "'>Form</button>";
    ...
    <div class="modal fade" id="formmodal" tabindex="-1" aria-labelledby="formecordLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" id="modal-body_form">
